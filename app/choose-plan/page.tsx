            ...
            <div className="max-w-[1200px] px-2 mx-auto">
                ...
                <div className='my-8'>
                    ...
                    <div className='bg-white flex flex-col items-center sticky bottom-0 py-6'>
                        {selectedPlan === "yearly" ? (
                            <>
                                <button className='bg-summarist-green py-2 px-8 w-[30%] min-w-fit mb-4 rounded-md'>Start your free 7 day trial</button>
                            ...
                            <>
                                <button className='bg-summarist-green py-2 px-8 w-[30%] min-w-fit mb-4 rounded-md'>Start your first month</button>
