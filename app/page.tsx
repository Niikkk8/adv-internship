            ...
            <div className="max-w-[1000px] m-auto px-4">
                ...
                <div className="flex mt-12 justify-center">
                    <div className="w-[80%] md:w-[50%] my-4 md:my-8 text-center md:text-left">
                        ...
                        <button className="bg-summarist-green w-[60%] py-2 rounded-md button-transform" onClick={() => dispatch(openLoginModal())}>Login</button>
                    </div>
                ...
                <div className="flex flex-col items-center my-12">
                    ...
                    <button className="bg-summarist-green w-[30%] py-2 rounded-md button-transform" onClick={() => dispatch(openLoginModal())}>Login</button>
