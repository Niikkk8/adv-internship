...
export default function Home() {
    ...
    const featuresData = [
        {
            ...
            para: "Save time by getting the core ideas from the latest books.",
        },
    ...
    const statsTitles1 = [
        ...
        "Improve your health",
        "Developer better parenting skills",
        "Increase Happiness",
    ...
    return (
        ...
        <div className="max-w-[1000px] m-auto px-4">
            ...
            {/*FEATURES SECTION*/}
            <div className="my-12">
                <h2 className="text-xl md:text-3xl font-bold text-center mb-8 text-[#032b41]">
            ...
            <div className="flex flex-col items-center justify-between md:flex-row">
                <div className="w-[90%] md:w-[50%] my-4 md:my-8">
                    {statsTitles1.map((title, index) => (
                        <h2
                            key={index}
                            className={`text-2xl md:text-3xl font-semibold text-[#6b757b] my-4 ${index === activeIndex1 ? "text-summarist-green" : ""
                                }`}>
                            {title}
                        </h2>
                    ))}
                ...
                <div className="w-[90%] md:w-[45%] my-4 md:my-8 bg-[#f1f6f4] px-4 py-6">
                    <div className="flex my-4 space-x-2 text-md md:text-xl">
                        <span className="font-semibold text-[#0365f2]">93%</span>
                        <p className="font-regular text-[#394547]">
                            of Summarist members <strong className="font-bold">significantly increase</strong> reading frequency
                        </p>
                    </div>
                    <div className="flex my-4 space-x-2 text-md md:text-xl">
                        <span className="font-semibold text-[#0365f2]">96%</span>
                        <p className="font-regular text-[#394547]">
                            of Summarist members <strong className="font-bold">establish better</strong> habits
                        </p>
                    </div>
                    <div className="flex my-4 space-x-2 text-md md:text-xl">
                        <span className="font-semibold text-[#0365f2]">90%</span>
                        <p className="font-regular text-[#394547]">
                            of Summarist members <strong className="font-bold">significant positive</strong> change to their lives
                        </p>
                    </div>
                </div>
            </div>
            <div className="flex flex-col-reverse items-center justify-between md:flex-row">
                <div className="w-[90%] md:w-[50%] my-4 md:my-8 bg-[#f1f6f4] px-6 py-8">
                    <div className="flex my-4 space-x-2 text-md md:text-xl">
                        ...
                        <p className="font-regular text-[#394547]">
                            of Summarist members <strong className="font-bold">report feeling more productive</strong> after
                    ...
                    <div className="flex my-4 space-x-2 text-md md:text-xl">
                        ...
                        <p className="font-regular text-[#394547]">
                            of Summarist members <strong className="font-bold">noticed an improvement</strong> in their overall
                    ...
                    <div className="flex my-4 space-x-2 text-md md:text-xl">
                        ...
                        <p className="font-regular text-[#394547]">
                            of Summarist members <strong className="font-bold">feel more informed</strong> about current events and
                ...
                <div className="w-[90%] md:w-[45%] my-4 md:my-8 text-left md:text-right">
                    {statsTitles2.map((title, index) => (
                        <h2
                            key={index}
                            className={`text-2xl md:text-3xl font-semibold text-[#6b757b] my-4 ${index === activeIndex2 ? "text-summarist-green" : ""
                                }`}>
                            {title}
                        </h2>
                    ))}
            ...
            <div className="flex flex-col items-center my-12">
                ...
                <div className="mb-4">
                    <div className="w-[90%] max-w-[700px] mx-auto my-6 p-6 bg-[#fff3d7]">
                        ...
                        <p className="text-md font-light text-[#394547]">
                            This app has been a <strong className="font-bold">game-changer</strong> for me! It's saved me so much
                            time and effort in reading and comprehending books. Highly recommend it to all book lovers.
                        </p>
                    </div>
                    <div className="w-[90%] max-w-[700px] mx-auto my-6 p-6 bg-[#fff3d7]">
                        <div className="flex items-center space-x-2">
                        ...
                        <p className="text-md font-light text-[#394547]">
                            I love this app! It provides <strong className="font-bold">concise and accurate summaries</strong> of
                            books in a way that is easy to understand. It's also very user-friendly and intuitive.
                        </p>
                    </div>
                    <div className="w-[90%] max-w-[700px] mx-auto my-6 p-6 bg-[#fff3d7]">
                        <div className="flex items-center space-x-2">
                        ...
                        <p className="text-md font-light text-[#394547]">
                            ...
                            <strong className="font-bold">The summaries are well-written and informative.</strong> Definitely worth
                            downloading.
                        </p>
                    </div>
                    <div className="w-[90%] max-w-[700px] mx-auto my-6 p-6 bg-[#fff3d7]">
                        ...
                        <p className="text-md font-light text-[#394547]">
                            ...
                            <strong className="font-bold">loves reading but doesn't have the time</strong> to read every book in
                            full, this app is for you! The summaries are thorough and provide a great overview of the book's
                            content.
                        </p>
                    </div>
                </div>
                {/* <button
            className="bg-summarist-green w-[30%] py-2 rounded-md button-transform"
            ...
            <div className="my-10">
                <h1 className="text-xl md:text-3xl font-bold text-center mb-8 text-[#032b41]">
